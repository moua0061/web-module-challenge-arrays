...
function addFlavor(arrName, newFlavor){
  arrName.splice(0,0, newFlavor);
  return arrName;
}
...
function getFlavorByIndex(arrName, num){
  /*your code here*/
  return arrName[num];
}
...
function removeFlavorByName(arrName, flavor){
  /*your code here*/
  let someThing = arrName.indexOf(flavor);
  arrName.splice(someThing, 1);
  return arrName;
}
...
function filterByWord(arrName, newString){
  /*your code here*/
  let newArr = [];
  for (let i =0; i < arrName.length; i++){
    if (arrName[i].includes(newString)){
